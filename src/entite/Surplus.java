...
public class Surplus 
{
	...
	public Surplus(int id, int empId, Time duree, Date date) {
		super();
		this.setId(id);
		this.setEmpId(empId);
		this.setDuree(duree);
	...
	public Surplus(int empId, Time duree, Date date) {
		super();
		this.setEmpId(empId);
		this.setDuree(duree);
		this.setDate(date);
	...
	public Surplus(String empId, String duree, String date)throws Exception{
		super();
		this.setEmpId(empId);
		this.setDuree(duree);
		this.setDate(date);
